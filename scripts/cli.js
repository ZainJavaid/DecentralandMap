...
const contractABI = require("../artifacts/contracts/Decentralandmap.sol/Decentralandmap.json").abi;

program
    .name("decentralandmap-cli")
    .description("CLI tool for Decentralandmap smart contract")
    .version("1.0.0");
