 ...
 * This file demonstrates how to integrate Decentralandmap with a web frontend
 */

// For React/Vue/Angular applications
export class DecentralandmapClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DecentralandmapClient(provider, contractAddress);
